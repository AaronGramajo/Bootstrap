...
const btncomprar = document.querySelector('#btn-procesar-compra-servicio')

const addCarrito = e => {
    if (e.target.classList.contains('btnPixel')) {
        abrir_cerrarCarrito()
        setTimeout(setCarrito(e.target.parentElement) ,3000)
    }
    e.stopPropagation()
}
